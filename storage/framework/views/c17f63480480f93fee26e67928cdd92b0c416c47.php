...
<body>
    <div class="m-6 bg-gray-100 rounded-xl p-2">
        <img src="<?php echo e(url('selar-logo-small.png')); ?>" width="100px" alt="logo" class="mx-auto">
        <div align="center" class="container md:w-4/5 xl:w-3/5  mx-auto px-2">
            <form action="" method="get">
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3 mb-6 md:mb-0">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="date" name="from" placeholder="yyyy-mm-dd" value="<?php echo e($from); ?>">
                    </div>
                    <div class="w-full px-3 pt-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-last-name">
                            End Date
                        </label>
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="date" name="to" placeholder="yyyy-mm-dd" value="<?php echo e($to); ?>">
                    </div>
            ...
            <div class="text-xl">
                <b>FILTER: </b><?php echo e($from); ?> <b>TO</b> <?php echo e($to); ?> (<?php echo e($diffHumans); ?>)
            </div>
                    ...
                    <div class="text-left">
                        <dl class="duration-1500 delay-500 flex flex-wrap divide-y divide-gray-200 border-b border-gray-200">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="w-full flex-none flex items-baseline px-4 sm:px-6 py-4">
                                    <dt class="w-2/5 sm:w-1/3 flex-none uppercase text-xs sm:text-sm font-semibold tracking-wide"><?php echo e($purchase->cur); ?></dt>
                                    <dt class="w-2/5 sm:w-1/3 text-black text-sm sm:text-base"><?php echo e(number_format($purchase->total_amount, 2)); ?> </dt>
                                    <dd class="text-black text-sm sm:text-base"><b><?php echo e(number_format($purchase->profit,2)); ?></b></dd>
                                </div>
                    ...
                    <div class="text-left">
                        <dl class="duration-1500 delay-500 flex flex-wrap divide-y divide-gray-200 border-b border-gray-200">
                            <div class="w-full flex-none flex items-baseline px-4 sm:px-6 py-4">
                                ...
                                <dd class="uppercase text-xs sm:text-sm font-semibold tracking-wide"><?php echo e($users->count()); ?></dd>
                            </div>
                        </dl>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="text-left">
                        <dl class="duration-1500 delay-500 flex flex-wrap divide-y divide-gray-200 border-b border-gray-200">
                            <div class="w-full flex-none flex items-baseline px-4 sm:px-6 py-4">
                                <dt class="w-2/5 sm:w-1/3 flex-none uppercase text-xs sm:text-sm font-semibold tracking-wide">Total Number: </dt>
                                <dd class="uppercase text-xs sm:text-sm font-semibold tracking-wide"><?php echo e($products->count()); ?></dd>
                            </div>
                        </dl>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="text-left">
                        <dl class="duration-1500 delay-500 flex flex-wrap divide-y divide-gray-200 border-b border-gray-200">
                            <div class="w-full flex-none flex items-baseline px-4 sm:px-6 py-4">
                                <dt class="w-2/5 sm:w-1/3 flex-none uppercase text-xs sm:text-sm font-semibold tracking-wide">Total Number: </dt>
                                <dd class="uppercase text-xs sm:text-sm font-semibold tracking-wide"><?php echo e($new_merchants->count()); ?></dd>
                            </div>
                        </dl>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="text-left">
                        <dl class="duration-1500 delay-500 flex flex-wrap divide-y divide-gray-200 border-b border-gray-200">
                            <div class="w-full flex-none flex items-baseline px-4 sm:px-6 py-4">
                                <dt class="w-2/5 sm:w-1/3 flex-none uppercase text-xs sm:text-sm font-semibold tracking-wide">Total Number: </dt>
                                <dd class="uppercase text-xs sm:text-sm font-semibold tracking-wide"><?php echo e($unique_merchants->count()); ?></dd>
                            </div>
                        </dl>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="text-left">
                        <dl class="duration-1500 delay-500 flex flex-wrap divide-y divide-gray-200 border-b border-gray-200">
                            <div class="w-full flex-none flex items-baseline px-4 sm:px-6 py-4">
                                <dt class="w-2/5 sm:w-1/3 flex-none uppercase text-xs sm:text-sm font-semibold tracking-wide">Total Number: </dt>
                                <dd class="uppercase text-xs sm:text-sm font-semibold tracking-wide"><?php echo e($new_sellers->count()); ?></dd>
                            </div>
                        </dl>
                    </div>
                </div>
                    ...
                    <div class="text-left">
                        <dl class="duration-1500 delay-500 flex flex-wrap divide-y divide-gray-200 border-b border-gray-200">
                            <div class="w-full flex-none flex items-baseline px-4 sm:px-6 py-4">
                                ...
                                <dd class="uppercase text-xs sm:text-sm font-semibold tracking-wide"><?php echo e(number_format($average, 2)); ?></dd>
                            </div>
                        </dl>
                    </div>
                </div>
...
<?php /**PATH /var/www/html/Work/selar/resources/views/home.blade.php ENDPATH**/ ?>